...
public:
    int mergeSorting(vector<int> &arr, int start, int mid, int end)
    {
        vector<int> temp;
        int i = start, j = mid + 1;
...
int main()
{
    ...
    int result1 = sort.selectionSort(arr, n);
    int result2 = sort.mergeSort(arr, 0, n - 1);
